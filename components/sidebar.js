...
import { HiChevronDoubleLeft, HiChevronDoubleRight, HiHome, HiViewList, HiSearch, HiUserGroup } from 'react-icons/hi';
...
const Sidebar = (props) => {
  ...
  const liClassName = `text-gray-50 no-underline hover:text-gray-50 py-2 flex align-middle ${menuOpen ? 'justify-start pl-2' : 'justify-center'}`;
